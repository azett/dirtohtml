package com.javaworld.markweakly;

import java.io.IOException;

/**
 * Taken from http://www.javaworld.com/javaworld/javatips/jw-javatip66.html - thx @ Mark Weakly :)
 * 
 * 
 * A simple, static class to display a URL in the system browser.
 * 
 * Under Unix, the system browser is hard-coded to be 'netscape'. Netscape must be in your PATH for this to work. This has been
 * tested with the following platforms: AIX, HP-UX and Solaris.
 * 
 * Under Windows, this will bring up the default browser under windows, usually either Netscape or Microsoft IE. The default browser
